...
def api_create_order(request, *, customer, price, phone, province, city, area, address, notes, payment, originalprice):
    ...
    address = areaData['provinces'][province]["name"]+areaData["provinces"][province]["citys"][city]["name"]+areaData["provinces"][province]["citys"][city]["countys"][area.strip()]["name"]+address
